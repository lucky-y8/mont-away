...
MESSAGES = {
    "zh-CN": {
        ...
        "verification_resent": "如果该邮箱已注册且尚未验证，新的验证邮件已经发送。",
    ...
    "en": {
        ...
        "verification_resent": "If the email is registered and unverified, a new verification message has been sent.",
    ...
    "ja": {
        ...
        "verification_resent": "登録済みで未確認の場合、新しい確認メールを送信しました。",
