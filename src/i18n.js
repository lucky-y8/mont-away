...
export const messages = {
  'zh-CN': {
    ...
    adminTitle: '内容审核', adminEntry: '进入管理后台', noReview: '当前没有待审核帖子。', reportQueue: '待处理举报', noReports: '当前没有待处理举报。', resolve: '标记已处理', resolutionPrompt: '填写处理结果', approve: '审核通过', remove: '下架', removalReason: '请输入下架原因',
  ...
  en: {
    ...
    adminTitle: 'Content review', adminEntry: 'Open admin console', noReview: 'There are no stories awaiting review.', reportQueue: 'Pending reports', noReports: 'There are no pending reports.', resolve: 'Mark resolved', resolutionPrompt: 'Describe the resolution', approve: 'Approve', remove: 'Remove', removalReason: 'Enter the removal reason',
  ...
  ja: {
    ...
    adminTitle: 'コンテンツ審査', adminEntry: '管理画面を開く', noReview: '審査待ちの投稿はありません。', reportQueue: '未処理の報告', noReports: '未処理の報告はありません。', resolve: '処理済みにする', resolutionPrompt: '処理結果を入力', approve: '承認', remove: '非公開', removalReason: '非公開の理由を入力',
