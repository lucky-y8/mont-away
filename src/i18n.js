...
export const messages = {
  'zh-CN': {
    ...
    weekly: '本周热门地点', bio: '把走过的路分享给你', sampleData: '页面数据均为开发示例', mapSample: '示意地图 · 非真实导航数据', mapLoading: '正在加载高德地图…',
  ...
  en: {
    ...
    weekly: 'Popular this week', bio: 'Sharing the paths I have walked', sampleData: 'All data on this page is for development only', mapSample: 'Demo map · Not navigation data', mapLoading: 'Loading AMap…',
  ...
  ja: {
    ...
    weekly: '今週の人気スポット', bio: '歩いた道をシェアします', sampleData: '画面のデータは開発用サンプルです', mapSample: 'サンプル地図 · ナビデータではありません', mapLoading: '高徳地図を読み込み中…',
